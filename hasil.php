                    ...
                    if (mysqli_num_rows($query) > 0) {
                        ...
                        while ($data = mysqli_fetch_array($query)) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php echo $data["gapipk"]; ?>
                                </td>
                                <td>
                                    <?php echo $data["gapps"]; ?>
                                </td>
                                <td>
                                    <?php echo $data["gapbing"]; ?>
                                </td>
                                <td>
                                    <?php echo $data["gapdk"]; ?>
                                </td>
                                <td>
                                    <?php echo $data["gappres"]; ?>
                                </td>
                                <td>
                                    <?php echo $data["gaptk"]; ?>
                                </td>
                                <td>
                                    <?php echo $data["gapukm"]; ?>
                                </td>
                                <td>
                                    <?php echo $data["gapdisiplin"]; ?>
                                </td>
                                <td>
                                    <?php echo $data["gapki"]; ?>
                                </td>
                                <td>
                                    <?php echo $data["gapsmt"]; ?>
                                </td>
                            </tr>
                            <?php $a++;
                        } ?>
                ...
                if (mysqli_num_rows($query) > 0) {
                    ...
                    while ($data = mysqli_fetch_array($query)) {
                        ...
                        <tr>
                            ...
                            <td>
                                <?php echo $data["bobotipk"]; ?>
                            </td>
                            <td>
                                <?php echo $data["bobotps"]; ?>
                            </td>
                            <td>
                                <?php echo $data["bobotbing"]; ?>
                            </td>
                            <td>
                                <?php echo $data["bobotdk"]; ?>
                            </td>
                            <td>
                                <?php echo $data["bobotpres"]; ?>
                            </td>
                            <td>
                                <?php echo $data["bobottk"]; ?>
                            </td>
                            <td>
                                <?php echo $data["bobotukm"]; ?>
                            </td>
                            <td>
                                <?php echo $data["bobotdisiplin"]; ?>
                            </td>
                            <td>
                                <?php echo $data["bobotki"]; ?>
                            </td>
                            <td>
                                <?php echo $data["bobotsmt"]; ?>
                            </td>
                            <td>
                                <?php echo $data["na"]; ?>
                            </td>
